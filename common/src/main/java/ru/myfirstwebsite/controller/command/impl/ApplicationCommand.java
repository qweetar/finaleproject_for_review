...
public class ApplicationCommand implements CommandInterface {
    ...
    private static class SingletonHolder {
        private static final CommandInterface INSTANCE = new ApplicationCommand();
    }
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws CommandException {
        ...
        try{
            ...
            Application newApplication = SERVICE.create(application);
